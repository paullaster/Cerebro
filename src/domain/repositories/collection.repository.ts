import {
  ...
  CollectionStatus,
  CollectionGrade,
} from '../entities/collection.entity.ts';
...
export interface ICollectionRepository {
  ...
  getTopFarmers(
    limit: number,
    dateRange?: DateRange,
  ): Promise<Array<{ farmerId: UUIDv7; totalAmount: Money; count: number }>>;

  getTopAgents(
    limit: number,
    dateRange?: DateRange,
  ): Promise<Array<{ agentId: UUIDv7; totalAmount: Money; count: number }>>;
