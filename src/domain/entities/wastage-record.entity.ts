...
export class WastageRecord extends Entity<UUIDv7> {
    ...
    // Getters
    getCollectionId(): UUIDv7 | null { return this.collectionId; }
    getAgentId(): UUIDv7 { return this.agentId; }
    getProduceTypeId(): UUIDv7 { return this.produceTypeId; }
    getWeightKg(): number { return this.weightKg; }
    getReason(): WastageReason { return this.reason; }
    getDeclaredAt(): Date { return this.declaredAt; }
