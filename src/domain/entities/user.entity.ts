...
export class UserCreatedEvent extends DomainEvent {
    constructor(public readonly userId: UUIDv7, public readonly email: Email) {
        super();
    }
...
export class User extends Entity<UUIDv7> {
    ...
    getNationalId(): string | null { return this.nationalId; }
    ...
    getIsPhoneVerified(): boolean { return this.isPhoneVerified; }
    getVerificationStatus(): VerificationStatus { return this.verificationStatus; }
    getProfilePhotoUrl(): string | null { return this.profilePhotoUrl; }
